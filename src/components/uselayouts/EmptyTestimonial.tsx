...
export default function EmptyTestimonial() {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center py-24 px-4 text-foreground">
                ...
                <div className="flex flex-col items-center gap-4 bg-transparent">
                    ...
                    >
                        <div className="w-6 h-6 rounded-full bg-primary flex items-center justify-center text-primary-foreground transition-transform duration-300">
                            <HugeiconsIcon icon={Add01Icon as any} size={16} strokeWidth={3} />
                        </div>
...
const Page = () => (
    <div className="w-full h-full bg-gradient-to-b from-white to-[#F5F5F7] rounded-xl border border-neutral-200 p-4 shadow-sm">
