...
export default function SmoothDropdown() {
    ...
    return (
        <div ref={containerRef} className="relative h-10 w-10 mx-auto">
            <motion.div
                layout
                initial={false}
                animate={{
            ...
            >
                <motion.div
                    ...
                    className="absolute inset-0 flex items-center justify-center h-10 w-10"
                    style={{
                            ...
                            {menuItems.map((item, index) => {
                                ...
                                return (
                                    <motion.li
                                        ...
                                        className={cn(
                                            "relative flex items-center gap-3 rounded-lg text-sm cursor-pointer transition-colors duration-200 ease-out pl-3 py-2",
