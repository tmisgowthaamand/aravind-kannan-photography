...
const MorphingInput = () => {
    ...
    return (
        <div className="bg-muted w-full max-w-sm py-1 flex justify-center items-center rounded-full px-1 mx-auto">
            <motion.button
                className="bg-background p-2.5 px-2.5 rounded-full flex items-center justify-center gap-1.5 transition-colors overflow-hidden cursor-pointer shadow-sm"
